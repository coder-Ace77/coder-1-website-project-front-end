    ...
    return (
        <div className="App">
            ...
            <div className="form-container">
                ...
                <TextareaAutosize className="textarea" placeholder="Enter tags" value={questionData.tags} onChange={(e) => handleInputChange('tags', e.target.value)} />
            ...
            {showPopup && (
                <div className="popup">
                    <div className="popup-content">
                        ...
                        <div>
                            <strong>Tags:</strong> <div>{questionData.tags}</div>
                        </div>
                        <div>
